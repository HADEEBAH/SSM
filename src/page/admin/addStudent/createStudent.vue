...
export default {
  ...
  methods: {
    ...
    selectPackage(course){
      course.option = {}
      course.package_data = course.course_data.packages.filter(v => v.package_id === course.package)[0]
    },
    addCourse() {
      this.order.courses.push({
        course_options : [],
