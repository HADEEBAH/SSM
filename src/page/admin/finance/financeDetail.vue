        ...
        content: [
          ...
          },
          {
            columns: [
              ...
              {
                text: `${this.order_detail.totalPrice.toLocaleString("en-US", {
                  minimumFractionDigits: 2,
                })} บาท`,
                margin: [0, 5],
                color: "#ff6b81",
                ...
                stack: [
                  {
                    text: `${moment(this.order_detail.payment.paid_date).format(
                      "DD/MM/YYYY"
                    )} ${this.order_detail.payment.paid_date.slice(11, 16)}น.`,
                    margin: [0, 5],
                    alignment: "center",
                  },
                  {
                ...
                stack: [
                  {
                    text: `${moment(this.order_detail.payment.paid_date).format(
                      "DD/MM/YYYY"
                    )} ${this.order_detail.payment.paid_date.slice(11, 16)}น.`, //ต้องแก้
                    margin: [0, 5],
                    alignment: "center",
                  },
                  {
