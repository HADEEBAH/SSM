    ...
    <v-container>
      ...
      <v-row>
        ...
        <v-col cols="12" class="text-center">
          <label class="font-weight-bold text-xl">เงื่อนไขการใช้บริการและนโยบายการคุ้มครองข้อมูลส่วนบุคคล</label>
        </v-col>
        <v-col cols="12" class="text-center">
          <label class="font-weight-bold text-xl">Term of Use and Personal Data Protection Policy</label>
        </v-col>
        <v-col cols="12">
          <TermOfUse/>
        </v-col>
