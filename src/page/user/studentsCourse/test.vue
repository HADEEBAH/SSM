                ...
                <v-card-text class="bg-[#FFF5F6]">
                  ...
                  <rowData col_header="4" col_detail="8" :title="$t('discount')"
                    ...
                    <span class="w-full font-bold">
                      {{
                        parseInt(
                          order_detail.totalDiscountPrice * student_length
                        ).toLocaleString(undefined, {
                          minimumFractionDigits: 2,
                        })
                      }}
                  ...
                  >
                    <span class="w-full font-bold">{{
                      order_detail.totalDiscount?.toLocaleString(undefined, {
                        minimumFractionDigits: 2,
                      })
                    }}</span>
                    {{ $t("baht") }}
                  ...
                  <rowData
                    ...
                    <span class="w-full font-bold">
                      {{
                        parseInt(
                          order_detail?.totalPrice - order_detail.totalDiscount
                        )?.toLocaleString(undefined, {
                          minimumFractionDigits: 2,
                        })
                      }}
...
export default {
  ...
  methods: {
    ...
    countStudents() {
      for (const items of this.order_detail.orderItem) {
        this.student_length = items.students.length;
      }
    },
    cancelOrderSuccess() {
      Swal.fire({
        ...
        var docDefinition = {
          ...
          content: [
            ...
            // Table
            {
              table: {
                headerRows: 1,
                widths: ["auto", "*", "auto", "auto", "auto"], // Adjusted for the new column
              ...
              columns: [
                {
                  ...
                  text: `(${
                    this.pdf_lang == "th"
                      ? convertToThaiBaht(this.lang_net_price)
                      : convertToEnglishCurrency(this.lang_net_price)
                  })`,
                  color: "#ff6b81",
                  margin: [0, 88.5, 0, 0],
                },
                  ...
                  columns: [
                    ...
                    },
                    {
                      stack: [
                        ...
                        // {
                        //   text: `${parseFloat(
                        //     this.order_detail.totalDiscount
                        //       ? this.order_detail.totalDiscount
                        //       : 0
                        //   )?.toLocaleString(undefined, {
                        //     minimumFractionDigits: 2,
            ...
            //     },
            //     {
            //       text: `${this.order_detail.orderId}`,
            //       margin: [0, 5],
            //       color: "#ff6b81",
            //       alignment: "center",
            //     },
    ...
    GenCourseItem() {
      let row = [
        [
          ...
          // {
          //   text: this.pdf_lang == "th" ? "ส่วนลด(บาท)" : "Discount(Baht)",
          //   fillColor: "#dedede",
          //   alignment: "center",
          // },
          // {
          ...
          //     this.pdf_lang == "th"
          //       ? "ส่วนลดเพิ่มเติม(บาท)"
          //       : "More Discount(Baht)", // New column header
          //   fillColor: "#dedede",
          //   alignment: "center",
          // },
        ],
      ...
      this.order_detail.orderItem.forEach((course, index) => {
        this.count_student = course.students.length;
        this.lang_net_price = parseInt(
          this.order_detail?.totalPrice - this.order_detail.totalDiscount
        );
        this.count_old_discount =
          (this.order_detail.totalDiscountPrice
            ? this.order_detail.totalDiscountPrice
            : 0) * this.count_student;
        row.push([
          {
            text: `${index + 1}`,
            alignment: "center",
          ...
          },
          {
            stack: [
              ...
              // remark
              {
                text: `*หมายเหตุ: ${course.remark ? course.remark : ""}`,
                color: "#ff6b81",
              },
            ],
            alignment: "left",
          ...
          // {
          //   text: `${parseFloat(this.order_detail?.totalPrice)?.toLocaleString(
          //     undefined,
          //     {
          //       minimumFractionDigits: 2,
          //       maximumFractionDigits: 2,
          ...
          // {
          //   text: `${parseFloat(
          //     // course?.cpo?.discountPrice ? course?.cpo?.discountPrice : 0
          //     this.count_old_discount
          //   )?.toLocaleString(undefined, {
          //     minimumFractionDigits: 2,
          //     maximumFractionDigits: 2,
