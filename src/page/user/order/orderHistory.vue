          ...
          <v-row>
            ...
            <v-col cols="9">
                    ...
                    <v-row dense>
                      <v-col class="text-md py-2" cols="12" sm="6">
                        <v-row dense>
                          ...
                          <v-col>{{
                            order.coachName ? order.coachName : "-"
                          }}</v-col>
                        </v-row>
                      </v-col>
                      <v-col class="text-md py-2" cols="12" sm="6">
              ...
              <v-card-text class="py-2">
                <v-row
                  dense
                  :class="order.show_student ? 'mb-3' : ''"
                  class="d-flex align-center"
                >
                  <v-col>
                    <v-btn
                      @click="order.show_student = !order.show_student"
                      text
                      class="font-bold"
