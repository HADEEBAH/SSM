    ...
    <v-card-text>
      ...
      <section>
        ...
        <p>
          ...
          โรงเรียนวรพัฒน์ หากไม่มี ข้อมูลดังกล่าว ระบบจะไม่สามารถทำงานโดยสมบูรณ์
      ...
      <section>
        ...
        <p>
          โรงเรียนวรพัฒน์ ได้รับข้อมูลส่วนบุคคล ด้วยความสมัครใจของผู้ใช้เท่านั้น
          โดยการลงทะเบียนใช้ โรง เรียนวรพัฒน์
      ...
      <section>
        ...
        <p>
          ...
          เพื่อนำไปใช้หรือเปิดเผยเท่าที่จำเป็น ภายใต้วัตถุประสงค์ในการใช้บริการ
      ...
      <section>
        ...
        <p>
          ...
          โรงเรียนวรพัฒน์ในโอกาสต่างๆ เพื่อเป็นประโยชน์แก่การแลกเปลี่ยนเรียนรู้
          และพัฒนาคุณภาพการจัด การศึกษาต่อ
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          แก้ไข หรือเปิดเผยข้อมูล ส่วนบุคคล โดยไม่มีสิทธิหรือโดยไม่ชอบด้วยกฏหมาย
          ...
          และไม่มีเหตุให้ต้องเก็บรักษาข้อมูลส่วน บุคคลนั้นต่อไป โรงเรียนวรพัฒน์
      ...
      <section>
        ...
        <p>
          ...
          สิทธิในการเข้าถึงข้อมูลส่วน บุคคล, สิทธิในการคัดค้านการเก็บรวบรวม ใช้
          หรือเปิดเผยข้อมูลส่วนบุคคล, สิทธิในการลบและแก้ไขข้อมูล ส่วนบุคคล
          เว้นแต่มีข้อจำกัดสิทธิโดยกฏหมาย ท่านสามารถติดต่อ โรงเรียนวรพัฒน์
          เพื่อให้ดำเนินการตามสิทธิข้างต้นได้ โดยไม่มีค่าใช้จ่ายใดๆ และ
          จะแจ้งผลตามคำร้อง ภายใน 30 วัน
        </p>
      </section>
